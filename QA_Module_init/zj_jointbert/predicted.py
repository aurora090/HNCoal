...
def get_args(pred_config):
    return torch.load(os.path.join("/workspace/HNCoal/QA_Module/zj_jointbert/model_mine/mk_major_000", 'training_args.bin'))
...
def load_model(pred_config, args, device):
    ...
    try:
        print('before')
        model_dir_review = os.path.join(os.path.dirname(__file__), args.model_dir)
        
        model = MODEL_CLASSES[args.model_type][1].from_pretrained(model_dir_review,
                                                                  args=args,
