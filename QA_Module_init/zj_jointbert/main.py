...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", default='hnmt',type=str, help="The name of the task to train")
    ...
    parser.add_argument("--data_dir", default="./data/hnmt", type=str, help="The input data dir")
    ...
    #args.model_name_or_path = 'zj_jointbert/model_mine/bert_base_chinese'
