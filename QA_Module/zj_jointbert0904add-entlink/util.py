...
script_dir = os.path.dirname(os.path.abspath(r'/workspace/HNCoal/QA_Module/zj_jointbert/model/modeling_jointbert.py'))
...
# transformers import BertTokenizer, AlbertForMaskedLM, FillMaskPipeline
