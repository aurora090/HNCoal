...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", default="/workspace/HNCoal/QA_Module/zj_jointbert/data_test/test_data_robert_1_entire.json", type=str, help="Input file for prediction")
