...
script_dir = os.path.dirname(os.path.abspath(r'/workspace/HNCoal/QA_Module/zj_jointbert/util.py'))
sys.path.append(script_dir)
from util import init_logger, load_tokenizer, get_intent_labels, get_slot_labels, MODEL_CLASSES
...
if __name__ == "__main__":
    ...
    input_dict = {}
    input_text = "可以告诉我灵泉煤矿采煤工作面有哪些设备吗"
    ...
    # 处理模型预测结果
    with open('/workspace/HNCoal/QA_Module/zj_jointbert/sample_pred_out.txt') as f:
